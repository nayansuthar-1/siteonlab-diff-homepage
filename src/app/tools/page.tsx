...
const tools = [
  {
    ...
    accent: "#22d3ee",
    description:
      "Get an instant, in-depth report on technical SEO, page speed, security, and best practices — powered by Google PageSpeed Insights and live header analysis.",
    tags: ["Technical SEO", "Performance", "Security", "Core Web Vitals"],
    icon: (
